...
var description = "";
var item = null;
var locs[0]  = new locale ( 0, "Town Square", description, item);
	locs[0].description = "You are in the starting location, Town Square.";
	
var locs[1]  = new locale ( 1, "North of Castle ", description, item);
...
var locs[2]   = new locale ( 2, "Entrance of Stumble Inn", description, item);
...
var locs[3]   = new locale ( 3, "Entrance of Stall", description, item);
	locs[3].description = "You are at the opened and smelly entrance of a stall. Please go EAST to enter the stall.";
	
var locs[4]   = new locale ( 4, "South Wall", description, item);
...
var locs[5]   = new locale ( 5, "BAR!", description, "Wine!");
...
var locs[6]   = new locale ( 6, "Stall", description, "Sword!");
...
var locs[7]   = new locale ( 7, "Tower", description, "Horse!");
...
var locs[8]   = new locale ( 8, "Girl", description, item);
	locs[8].description = "You recognize that passed-out girl...O yeah you had a drinking contest with her last night, I guess you won. You get +10 points for being a noble visitor!!";
	
var locs[9]   = new locale ( 9, "North of Stall Entrance", description, "Shield!");
	locs[9].description = "You were everywhere last night, is that your SHIELD on the ground over there?";
	
var locs[10]  = new locale (10, "Far North", description, item);
	locs[10].required = "Horse!";
	locs[10].description = "";
	
var locs[11]  = new locale (11, "North Table in Bar", description, "Helmet!");
	locs[11].description = "You find a passed out townsman using your helmet as cup....o well it's better than nothing I suggest you take it back. Also, you find yourself curious as too what is through that slightly opened door NORTH of you..";
	
var locs[12]  = new locale (12, "Seceret Meeting", description, item);
